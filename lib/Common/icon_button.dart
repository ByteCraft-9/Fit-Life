...
class FFIconButton extends StatefulWidget {
  const FFIconButton({
    Key? key,
    required this.icon,
    this.borderColor,
  ...
  @override
  State<FFIconButton> createState() => _FFIconButtonState();
}

class _FFIconButtonState extends State<FFIconButton> {
  bool loading = false;
  ...
  @override
  void didUpdateWidget(FFIconButton oldWidget) {
