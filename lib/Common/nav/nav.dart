...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? NavBarPage() : const OnboardingWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          path: '/fitness',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'Fitness')
              : const FitnessWidget(),
        ),
        FFRoute(
          name: 'ExerciseDetail',
          path: '/exerciseDetail',
          asyncParams: {
            'exdt': getDoc(['exercises'], ExercisesRecord.fromSnapshot),
          },
          builder: (context, params) => ExerciseDetailWidget(
            exdt: params.getParam(
              'exdt',
              ParamType.Document,
            ),
          ),
        ...
        FFRoute(
          ...
          path: '/mealDetail',
          asyncParams: {
            'mldt': getDoc(['Meal'], MealRecord.fromSnapshot),
          },
          builder: (context, params) => MealDetailWidget(
            mldt: params.getParam(
              'mldt',
              ParamType.Document,
            ),
          ),
        ...
        FFRoute(
          name: 'TermsCond',
          path: '/termsCond',
          builder: (context, params) => const TermsCondWidget(),
        ),
        FFRoute(
          name: 'Tutorial',
          path: '/tutorial',
