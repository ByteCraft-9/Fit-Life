                    ...
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsetsDirectional.fromSTEB(
                            44.0, 8.0, 44.0, 0.0),
                        child: Text(
                          'We\'re excited to support you on your journey to a healthier, fitter you with personalized plans and expert guidance.',
                        ...
                        child: FFButtonWidget(
                          ...
                          options: FFButtonOptions(
                            ...
                            iconPadding: const EdgeInsetsDirectional.fromSTEB(
                                0.0, 0.0, 0.0, 0.0),
                            color: FFTheme.of(context).accent3,
                            textStyle: FFTheme.of(context).bodyLarge.override(
                                  fontFamily: 'Inter',
                                  letterSpacing: 0.0,
                                ),
                            elevation: 0.0,
